...
public class Informacao8 {
    ...
    public static class MapperInformacao extends Mapper<Object, Text, Text, LongWritable> {
        ...
        public void map(Object chave, Text valor, Context context) throws IOException, InterruptedException {
            try {
                ...
                if (campos.length == 10) {
                    ...
                    Text chaveCampo = new Text(campos[1] + "-" + campos[3]);
    ...
    public static class ReducerInformacao extends Reducer<Text, LongWritable, Text, LongWritable> {
        
        @Override
        public void reduce(Text chave, Iterable<LongWritable> valores, Context context) throws IOException, InterruptedException {
            int i = 0;
            
            for (LongWritable intvalores : valores) {
                i += intvalores.get();
            }
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        String arquivoSaida = "/home2/ead2022/SEM1/felipe.alberto/Desktop/implementacaoLocalMR/informacao8";
